...
function WarrantySection() {
  return (
    <div className="border-t border-gray-300 p-12 flex flex-col">
      <h4 className="text-lg mb-10">Warranty</h4>
      <div className="flex flex-col">
        <span>
          <p className="text-base text-black">
            Security guarantee in your purchase
          </p>
          <p className="mt-1 text-sm text-gray-600 leading-5">
            Receive product you are waiting for or refund your money
          </p>
        </span>
        <span className="mt-4">
          <p className="text-base text-black">Seller guarantee</p>
          <p className="mt-1 text-sm text-gray-600 leading-5">No warranty</p>
        </span>
      </div>
